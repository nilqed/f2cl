    ...
    (f2cl-lib:with-multi-array-data
      ...
      (labels ((cabs1 (cdum)
        ...
        (prog ((zdum (make-array 1 :element-type 'f2cl-lib:complex16))
              ...
              (multiple-value-bind
                ...
                (declare
                 (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-8 var-9
                  var-10 var-14 var-15 var-17 var-18 var-20 var-21 var-23
                  var-24))
                (setf ldh var-7)
                (setf ldz var-11)
                (setf ls var-12)
                  ...
                  (multiple-value-bind
                    ...
                    (declare
                     (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-8
                      var-9 var-10 var-14 var-15 var-17 var-18 var-20 var-21
                      var-23 var-24))
                    (setf ldh var-7)
                    (setf ldz var-11)
                    (setf ls var-12)
                   ...
                   ((or (= ld 0)
                    ...
                    (multiple-value-bind
                        ...
                        (zlaqr5 wantt wantz kacc22 n ktop kbot ns
                         ...
                         ldh)
                      (declare
                       (ignore var-7 var-8 var-12 var-14 var-15 var-16 var-19
                        var-22))
         ...
         end_label
          (return
           (values wantt wantz n nil nil nil ldh nil iloz ihiz nil ldz nil nil
                   info)))))))
  ...
  (setf (gethash 'fortran-to-lisp::zlaqr4
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            '(fortran-to-lisp::logical
                                              ...
                                              (fortran-to-lisp::integer4))
                                            :return-values
                                            '(fortran-to-lisp::wantt
                                              fortran-to-lisp::wantz
                                              fortran-to-lisp::n nil nil nil
                                              fortran-to-lisp::ldh nil
                                              fortran-to-lisp::iloz
                                              fortran-to-lisp::ihiz nil
                                              fortran-to-lisp::ldz nil nil
