    ...
    (f2cl-lib:with-multi-array-data
      ...
      (labels ((cabs1 (cdum)
        ...
        (prog ((cdum #C(0.0d0 0.0d0)) (ovfl 0.0d0) (remax 0.0d0) (scale 0.0d0)
                ...
                (cond
                 ((> ki 1)
                  (multiple-value-bind
                    ...
                    (when var-8 (setf scale var-8))
                    (when var-10 (setf info var-10)))
         ...
         end_label
          (return
           (values nil nil nil nil nil ldt nil nil nil nil nil m nil nil
                   info)))))))
