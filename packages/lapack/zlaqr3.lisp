          ...
          (cond ((<= jw 2) (setf lwkopt 1))
                (t
                 ...
                 (multiple-value-bind
                   ...
                   (declare
                    (ignore var-0 var-1 var-3 var-5 var-7 var-8 var-10 var-12
                     var-13))
                   (when var-2 (setf jw var-2))
                   (when var-4 (setf jw var-4))
                   (when var-6 (setf ldt var-6))
                   (when var-9 (setf jw var-9))
                   (when var-11 (setf ldv var-11))
         ...
         end_label
          (return
           (values nil nil nil nil nil nil nil ldh nil nil nil ldz ns nd nil
                   nil ldv nil nil ldt nil nil ldwv nil lwork)))))))
  ...
  (setf (gethash 'fortran-to-lisp::zlaqr3
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil nil nil nil nil
                                              ...
                                              fortran-to-lisp::ldt nil nil
                                              fortran-to-lisp::ldwv nil
