                 ...
                 (cond
                  (wantvl
                   ...
                   (multiple-value-bind
                     ...
                     (declare
                      (ignore var-0 var-1 var-3 var-4 var-5 var-7 var-8 var-10
                       var-11))
                     (setf n var-2)
                     (setf lda var-6)
                     (setf ldvl var-9)
        ...
        (cond
         (wantvl (f2cl-lib:f2cl-set-string side "L" (string 1))
          ...
          (multiple-value-bind
            ...
            (declare
             (ignore var-0 var-1 var-3 var-4 var-5 var-7 var-8 var-10 var-11))
            (setf n var-2)
            (setf lda var-6)
            (setf ldvl var-9)
            (setf info var-12))
         ...
         ((or wantvl wantvr) (setf irwork (f2cl-lib:int-add ibal n))
          (multiple-value-bind
              ...
              (ztrevc side "B" select n a lda vl ldvl vr ldvr n nout
               ...
               ierr)
            (declare
             (ignore var-0 var-1 var-2 var-3 var-4 var-6 var-7 var-8 var-9
