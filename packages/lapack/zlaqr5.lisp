    ...
    (f2cl-lib:with-multi-array-data
      ...
      (labels ((cabs1 (cdum)
        ...
        (prog ((vt (make-array 3 :element-type 'f2cl-lib:complex16))
                  ...
                  (f2cl-lib:fdo (jcol
                    ...
                    (tagbody
                      ...
                      (multiple-value-bind
                        ...
                        (when var-1 (setf nu var-1))
                        (when var-2 (setf jlen var-2))
                        (when var-4 (setf ldwh var-4))
                    ...
                    (tagbody
                      ...
                      (multiple-value-bind
                          ...
                          (zlacpy "ALL" knz jlen
                           ...
                           ldwh)
                        (declare (ignore var-0 var-3 var-5))
                        (when var-1 (setf knz var-1))
                        (when var-2 (setf jlen var-2))
                        (when var-4 (setf ldh var-4))
         ...
         end_label
          (return
           (values nil nil nil nil nil nil nil nil nil ldh nil nil nil ldz nil
                   nil nil ldu nil nil ldwv nil nil ldwh)))))))
  ...
  (setf (gethash 'fortran-to-lisp::zlaqr5
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil nil nil nil nil nil
                                              nil fortran-to-lisp::ldh nil nil
                                              nil fortran-to-lisp::ldz nil nil
                                              nil fortran-to-lisp::ldu nil nil
                                              fortran-to-lisp::ldwv nil nil
