      ...
      (prog ((cheb12 (make-array 13 :element-type 'double-float))
        ...
        (declare (type (array double-float (28)) v)
                 ...
                 (type (double-float) sinpar ress24 ress12 resc24 resc12 p4 p3
                  p2 par22 par2 parint oflow hlgth ests estc cospar cons$ conc
                  centr ass asap as an2 an ac)
       ...
       label10
        ...
        (setf (f2cl-lib:fref v (1) ((1 28))) (/ (* 2.0d0 sinpar) parint))
        ...
        (if (> (f2cl-lib:dabs parint) 24.0d0)
            (go label30))
        (setf noequ 25)
        ...
        (setf (f2cl-lib:fref v (4) ((1 28)))
                (+ (f2cl-lib:fref v (4) ((1 28)))
                   (* -56.0d0 par2 (f2cl-lib:fref v (3) ((1 28))))))
