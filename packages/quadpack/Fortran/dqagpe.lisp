    ...
    (prog ((res3la (make-array 3 :element-type 'double-float))
      ...
      (declare (type (array double-float (52)) rlist2)
               ...
               (type (double-float) uflow temp f2cl-lib:sign reseps resabs resa
                oflow ertest errsum error2 erro12 error1 errmax errbnd erlast
                erlarg epmach dres defab2 defab1 defabs correc b2 b1 a2 a1
                area2 area12 area1 area abseps)
               (type (f2cl-lib:integer4) numrl2 nrmax nres npts nintp1
                f2cl-lib:nint maxerr levmax levcur ktmin ksgn k jupbnd jlow j
                iroff3 iroff2 iroff1 ip1 ind2 ind1 ierro id i)
     ...
     label80
      ...
      (setf abserr oflow)
      (setf ksgn -1)
      (if (>= dres (* (- 1.0d0 (* 50.0d0 epmach)) resabs))
          (setf ksgn 1))
