    ...
    (prog ((res3la (make-array 3 :element-type 'double-float))
      ...
      (declare (type (array double-float (52)) rlist2)
               ...
               (type (double-float) uflow small reseps resabs oflow ertest
                ...
                dres defab2 defab1 defabs correc b2 b1 boun a2 a1 area2 area12
                area1 area abseps)
      ...
      (setf result 0.0d0)
      (setf abserr 0.0d0)
      (setf (f2cl-lib:fref alist-%data% (1) ((1 limit)) alist-%offset%) 0.0d0)
      (setf (f2cl-lib:fref blist-%data% (1) ((1 limit)) blist-%offset%) 1.0d0)
