      ...
      (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
        ...
        (tagbody
          (setf (f2cl-lib:fref sum-%data% (j) ((1 1)) sum-%offset%)
                  (ddot n
                   (f2cl-lib:array-slice qr-%data% double-float (1 j)
                                         ((1 ndim) (1 1)) qr-%offset%)
                   1
                   (f2cl-lib:array-slice qr-%data% double-float (1 j)
                                         ((1 ndim) (1 1)) qr-%offset%)
                   1))
      ...
      (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
        ...
        (tagbody
          ...
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
            ...
            (tagbody
              (setf sigma
                      (f2cl-lib:fref qr-%data% (i k) ((1 ndim) (1 1))
                                     qr-%offset%))
              (setf (f2cl-lib:fref qr-%data% (i k) ((1 ndim) (1 1))
                                   qr-%offset%)
                      (f2cl-lib:fref qr-%data% (i jbar) ((1 ndim) (1 1))
                                     qr-%offset%))
              (setf (f2cl-lib:fref qr-%data% (i jbar) ((1 ndim) (1 1))
                                   qr-%offset%)
                      sigma)
             label50))
         label70
          (setf sigma
                  (ddot (f2cl-lib:int-add (f2cl-lib:int-sub n k) 1)
                   (f2cl-lib:array-slice qr-%data% double-float (k k)
                                         ((1 ndim) (1 1)) qr-%offset%)
                   1
                   (f2cl-lib:array-slice qr-%data% double-float (k k)
                                         ((1 ndim) (1 1)) qr-%offset%)
                      ...
                      (* beta
                         (ddot (f2cl-lib:int-add (f2cl-lib:int-sub n k) 1)
                          (f2cl-lib:array-slice qr-%data% double-float (k k)
                                                ((1 ndim) (1 1)) qr-%offset%)
                          1
                          (f2cl-lib:array-slice qr-%data% double-float (k j)
                                                ((1 ndim) (1 1)) qr-%offset%)
                          1)))))
          (f2cl-lib:fdo (j kp1 (f2cl-lib:int-add j 1))
                        ((> j np1) nil)
            (tagbody
              (f2cl-lib:fdo (i k (f2cl-lib:int-add i 1))
                            ((> i n) nil)
                (tagbody
                  (setf (f2cl-lib:fref qr-%data% (i j) ((1 ndim) (1 1))
                                       qr-%offset%)
                          (-
                           (f2cl-lib:fref qr-%data% (i j) ((1 ndim) (1 1))
                                          qr-%offset%)
                           (*
                            (f2cl-lib:fref qr-%data% (i k) ((1 ndim) (1 1))
                                           qr-%offset%)
              ...
              (setf (f2cl-lib:fref sum-%data% (j) ((1 1)) sum-%offset%)
                      (- (f2cl-lib:fref sum-%data% (j) ((1 1)) sum-%offset%)
                         (expt
                          (f2cl-lib:fref qr-%data% (k j) ((1 ndim) (1 1))
                                         qr-%offset%)
                          2)))
             label100))
         label500))
