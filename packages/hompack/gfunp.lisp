    ...
    (prog ((i 0) (j 0))
      ...
      (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
        ...
        (tagbody
          (powp
           (f2cl-lib:int-sub
            (f2cl-lib:fref ideg-%data% (j) ((1 n)) ideg-%offset%) 1)
           (f2cl-lib:array-slice x-%data% double-float (1 j) ((1 2) (1 n))
                                 x-%offset%)
           (f2cl-lib:array-slice xdgm1-%data% double-float (1 j) ((1 2) (1 n))
                                 xdgm1-%offset%))
          (mulp
           (f2cl-lib:array-slice x-%data% double-float (1 j) ((1 2) (1 n))
                                 x-%offset%)
           (f2cl-lib:array-slice xdgm1-%data% double-float (1 j) ((1 2) (1 n))
                                 xdgm1-%offset%)
           (f2cl-lib:array-slice xdg-%data% double-float (1 j) ((1 2) (1 n))
                                 xdg-%offset%))
         label5))
      (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                    ((> j n) nil)
        (tagbody
          (mulp
           (f2cl-lib:array-slice pdg-%data% double-float (1 j) ((1 2) (1 n))
                                 pdg-%offset%)
           (f2cl-lib:array-slice xdgm1-%data% double-float (1 j) ((1 2) (1 n))
                                 xdgm1-%offset%)
           (f2cl-lib:array-slice pxdgm1-%data% double-float (1 j) ((1 2) (1 n))
                                 pxdgm1-%offset%))
         label10))
      (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                    ((> j n) nil)
        (tagbody
          (mulp
           ...
           (f2cl-lib:array-slice xdg-%data% double-float (1 j) ((1 2) (1 n))
                                 xdg-%offset%)
           (f2cl-lib:array-slice pxdg-%data% double-float (1 j) ((1 2) (1 n))
                                 pxdg-%offset%))
         label20))
      (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
                    ((> j n) nil)
          ...
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
            ...
            (tagbody
              (setf (f2cl-lib:fref g-%data% (i j) ((1 2) (1 n)) g-%offset%)
                      (-
                       (f2cl-lib:fref pxdg-%data% (i j) ((1 2) (1 n))
                                      pxdg-%offset%)
                       (f2cl-lib:fref qdg-%data% (i j) ((1 2) (1 n))
                                      qdg-%offset%)))
              (setf (f2cl-lib:fref dg-%data% (i j) ((1 2) (1 n)) dg-%offset%)
                      (* (f2cl-lib:fref ideg-%data% (j) ((1 n)) ideg-%offset%)
                         (f2cl-lib:fref pxdgm1-%data% (i j) ((1 2) (1 n))
                                        pxdgm1-%offset%)))
             label30))))
     label30
      (go end_label)
