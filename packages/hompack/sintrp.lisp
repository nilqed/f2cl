      ...
      (f2cl-lib:fdo (i m (f2cl-lib:int-add i 1))
        ...
        (tagbody
         label40
          (setf gdi
                  (-
                   (f2cl-lib:fref w-%data% ((f2cl-lib:int-sub kp2 i)) ((1 12))
                                  w-%offset%)
             ...
             label70
              (setf (f2cl-lib:fref wtemp (jq) ((1 13)))
                      (- (* gamma (f2cl-lib:fref wtemp (jq) ((1 13))))
                         (* alp
                            (f2cl-lib:fref wtemp ((f2cl-lib:int-add jq 1))
                                           ((1 13))))))))
        ...
        (tagbody
          ...
          (setf gdif
                  (- (f2cl-lib:fref g-%data% (i) ((1 13)) g-%offset%)
                     (f2cl-lib:fref g-%data% ((f2cl-lib:int-sub i 1)) ((1 13))
                                    g-%offset%)))
          (setf temp2
          ...
          (f2cl-lib:fdo (l 1 (f2cl-lib:int-add l 1))
            ...
            (tagbody
             ...
             label110
              (setf (f2cl-lib:fref ypout-%data% (l) ((1 neqn)) ypout-%offset%)
                      (+
                       (f2cl-lib:fref ypout-%data% (l) ((1 neqn))
                                      ypout-%offset%)
                       (* temp3
                          (f2cl-lib:fref phi-%data% (l i) ((1 neqn) (1 16))
                                         phi-%offset%))))))
