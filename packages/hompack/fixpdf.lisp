...
(let* ((limitd 1000))
  ...
  (let ((y1sout 0.0d0)
    ...
    (declare
     (type (double-float) y1sout xold sqnp1 sout sb sa s99 s hold h epst epsstp
      curtol cursw aold)
     (type (f2cl-lib:integer4) np1 nfec limit lcode ksteps kold kgi k jw judy j
      ivc iter iflagc)
      ...
      (f2cl-lib:with-multi-array-data
        ...
        (prog ()
         ...
         label10
          ...
          (if (<= arctol 0.0)
              (setf arctol (* 0.5 (f2cl-lib:fsqrt eps))))
          (setf nfec 0)
          (setf iflagc iflag)
          ...
          (setf epsstp arctol)
          (setf ksteps 0)
          (setf (f2cl-lib:fref ypold-%data% (1) ((1 (f2cl-lib:int-add n 1)))
                               ypold-%offset%)
                  (coerce 1.0 'double-float))
          (setf (f2cl-lib:fref yp-%data% (1) ((1 (f2cl-lib:int-add n 1)))
                               yp-%offset%)
                  (coerce 1.0 'double-float))
          (setf (f2cl-lib:fref y-%data% (1) ((1 (f2cl-lib:int-add n 1)))
                               y-%offset%)
                  (coerce 0.0 'double-float))
          (f2cl-lib:fdo (j 2 (f2cl-lib:int-add j 1))
                        ((> j np1) nil)
            (tagbody
              (setf (f2cl-lib:fref ypold-%data% (j)
                                   ((1 (f2cl-lib:int-add n 1))) ypold-%offset%)
                      (coerce 0.0 'double-float))
              (setf (f2cl-lib:fref yp-%data% (j) ((1 (f2cl-lib:int-add n 1)))
                                   yp-%offset%)
                      (coerce 0.0 'double-float))
             label20))
          (cond
           ((>= iflagc (f2cl-lib:int-sub 1))
            (f2cl-lib:fdo (j 2 (f2cl-lib:int-add j 1))
                          ((> j np1) nil)
              (tagbody
                (setf (f2cl-lib:fref a-%data% ((f2cl-lib:int-sub j 1)) ((1 n))
                                     a-%offset%)
                        (f2cl-lib:fref y-%data% (j)
              ...
              (cond
               ((= iflagc (f2cl-lib:int-sub 2))
                (f2cl-lib:fdo (jw 1 (f2cl-lib:int-add jw 1))
                              ((> jw ndima) nil)
                  (tagbody
                    (setf (f2cl-lib:fref qr-%data% (jw 1)
                                         ((1 n) (1 (f2cl-lib:int-add n 1)))
                                         qr-%offset%)
                            (f2cl-lib:fref a-%data% (jw) ((1 n)) a-%offset%))
                   label63))
                (rhoa a
                 (f2cl-lib:fref y-%data% (1) ((1 (f2cl-lib:int-add n 1)))
                                y-%offset%)
                 (f2cl-lib:array-slice y-%data% double-float (2)
                                       ((1 (f2cl-lib:int-add n 1))) y-%offset%)
                 par ipar)
                (f2cl-lib:fdo (jw 1 (f2cl-lib:int-add jw 1))
                              ((> jw ndima) nil)
                  (tagbody
                    (setf aold
                            (f2cl-lib:fref qr-%data% (jw 1)
                                           ((1 n) (1 (f2cl-lib:int-add n 1)))
                                           qr-%offset%))
                    (cond
                     ((> (abs (+ (f2cl-lib:fref a (jw) ((1 n))) (- aold)))
                         (+ 1.0 (abs aold)))
                      (setf arclen (+ arclen s)) (setf iflag 5)
                      (go end_label)))
                   label65)))
               (t
                (f
                     ...
                     ((= iflagc (f2cl-lib:int-sub 1))
                      (setf (f2cl-lib:fref a-%data% (jw) ((1 n)) a-%offset%)
                              (+
                               (/
                                (*
                                 (f2cl-lib:fref y-%data% (1)
                                                ((1 (f2cl-lib:int-add n 1)))
                                                y-%offset%)
                                 (f2cl-lib:fref yp-%data% (jw)
                                                ((1 (f2cl-lib:int-add n 1)))
                                                yp-%offset%))
                                (- 1.0
                                   (f2cl-lib:fref y-%data% (1)
             ...
             label100
                   ...
                   ((<=
                     (abs
                      (+ (f2cl-lib:fref yp (jw) ((1 (f2cl-lib:int-add n 1))))
                         (-
                          (f2cl-lib:fref ypold (jw)
                                         ((1 (f2cl-lib:int-add n 1)))))))
                     curtol)
                    (setf (f2cl-lib:fref wt-%data% (jw)
                                         ((1 (f2cl-lib:int-add n 1)))
                                         wt-%offset%)
                            (+
                             (abs
                              (f2cl-lib:fref y-%data% (jw)
                                             ((1 (f2cl-lib:int-add n 1)))
                                             y-%offset%))
                             1.0)))
                   (t
              ...
              (multiple-value-bind
                  (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
                   ...
                   var-18 var-19 var-20 var-21 var-22 var-23 var-24 var-25
                   var-26 var-27 var-28 var-29 var-30 var-31 var-32 var-33)
                ...
                (declare
                 (ignore var-0 var-1 var-2 var-6 var-12 var-13 var-14 var-15
                  var-16 var-17 var-21 var-23 var-24 var-25 var-26 var-27
                  var-28 var-29 var-32 var-33))
                (setf s var-3)
                (setf h var-4)
                (setf epsstp var-5)
                (setf start var-7)
              ...
              (setf nfe nfec)
              (cond
               ((= iflagc 4) (setf arclen (+ arclen s)) (setf iflag 4)
                (go end_label)))
             label120
              (cond
               (crash (setf iflag 2) (setf eps epsstp)
                (if (< arctol eps)
                    (setf arctol eps))
                (setf limit (f2cl-lib:int-sub limit iter)) (go end_label)))
             label130
              (cond
                ...
                (tagbody
                 ...
                 label135
                  (sintrp s y s99 wt yp np1 kold phi ivc iv kgi gi alphas g w
                   xold p)
                  (if (<
                       (f2cl-lib:fref wt-%data% (1)
                                      ((1 (f2cl-lib:int-add n 1))) wt-%offset%)
                       1.0)
                      (go label140))
                 ...
                 label140
                  (f2cl-lib:fdo (judy 1 (f2cl-lib:int-add judy 1))
                                ((> judy np1) nil)
                    (tagbody
                      (setf (f2cl-lib:fref y-%data% (judy)
                                           ((1 (f2cl-lib:int-add n 1)))
                                           y-%offset%)
                              (f2cl-lib:fref wt-%data% (judy)
                                             ((1 (f2cl-lib:int-add n 1)))
                                             wt-%offset%))
                      (setf (f2cl-lib:fref ypold-%data% (judy)
                                           ((1 (f2cl-lib:int-add n 1)))
                                           ypold-%offset%)
                              (f2cl-lib:fref yp-%data% (judy)
                                             ((1 (f2cl-lib:int-add n 1)))
                                             yp-%offset%))
                     label144))
                  (setf s s99)
         ...
         label170
          ...
          (setf y1sout
                  (-
                   (f2cl-lib:fref wt-%data% (1) ((1 (f2cl-lib:int-add n 1)))
                                  wt-%offset%)
                   1.0))
          (go label170)
         label190
          ...
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
            ...
            (tagbody
             label210
              (setf (f2cl-lib:fref y-%data% (j) ((1 (f2cl-lib:int-add n 1)))
                                   y-%offset%)
                      (f2cl-lib:fref wt-%data% (j) ((1 (f2cl-lib:int-add n 1)))
                                     wt-%offset%))))
          (go end_label)
         end_label
          (return
           (values nil nil iflag arctol eps nil nil nil nfe arclen nil nil nil
  ...
  (setf (gethash 'fortran-to-lisp::fixpdf
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil fortran-to-lisp::iflag
                                              fortran-to-lisp::arctol
                                              fortran-to-lisp::eps nil nil nil
                                              fortran-to-lisp::nfe
                                              fortran-to-lisp::arclen nil nil
                                              nil nil nil nil nil nil nil nil
                                              nil)
                                            :calls
                                            '(fortran-to-lisp::root
                                              fortran-to-lisp::sintrp
