...
(defun hfun1p
  ...
  (declare (type (array f2cl-lib:integer4 (*)) kdeg numt ideg)
           ...
           (type (array double-float (*)) dxnp1 clx dtrm trm xx df f pxdg
            pxdgm1 dg g xdg xdgm1 drhol drhox rho coef cl pdg x qdg))
        ...
        (tagbody
          ...
          (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
            ...
            (tagbody
              ...
              (setf (f2cl-lib:fref drhox-%data% (j2m1 k2m1)
                                   ((1 (f2cl-lib:int-mul 2 n))
                                    (1 (f2cl-lib:int-mul 2 n)))
                                   drhox-%offset%)
                      (* lambda$
                         (f2cl-lib:fref df-%data% (1 j k)
                                        ((1 2) (1 n)
                                         (1 (f2cl-lib:int-add n 1)))
                                        df-%offset%)))
              (setf (f2cl-lib:fref drhox-%data% (j2 k2)
                                   ((1 (f2cl-lib:int-mul 2 n))
                                    (1 (f2cl-lib:int-mul 2 n)))
                                   drhox-%offset%)
                      (f2cl-lib:fref drhox-%data% (j2m1 k2m1)
                                     ((1 (f2cl-lib:int-mul 2 n))
                                      (1 (f2cl-lib:int-mul 2 n)))
                                     drhox-%offset%))
              (setf (f2cl-lib:fref drhox-%data% (j2 k2m1)
                                   ((1 (f2cl-lib:int-mul 2 n))
                                    (1 (f2cl-lib:int-mul 2 n)))
                                   drhox-%offset%)
                      (* lambda$
                         (f2cl-lib:fref df-%data% (2 j k)
                                        ((1 2) (1 n)
                                         (1 (f2cl-lib:int-add n 1)))
                                        df-%offset%)))
              (setf (f2cl-lib:fref drhox-%data% (j2m1 k2)
                                   ((1 (f2cl-lib:int-mul 2 n))
                                    (1 (f2cl-lib:int-mul 2 n)))
                                   drhox-%offset%)
                      (-
                       (f2cl-lib:fref drhox-%data% (j2 k2m1)
                                      ((1 (f2cl-lib:int-mul 2 n))
                                       (1 (f2cl-lib:int-mul 2 n)))
                                      drhox-%offset%)))
             label20))
          (setf (f2cl-lib:fref drhox-%data% (j2m1 j2m1)
                               ((1 (f2cl-lib:int-mul 2 n))
                                (1 (f2cl-lib:int-mul 2 n)))
                               drhox-%offset%)
                  (+
                   (f2cl-lib:fref drhox-%data% (j2m1 j2m1)
                                  ((1 (f2cl-lib:int-mul 2 n))
                                   (1 (f2cl-lib:int-mul 2 n)))
                                  drhox-%offset%)
                   (* oneml
                      (f2cl-lib:fref dg-%data% (1 j) ((1 2) (1 n))
                                     dg-%offset%))))
          (setf (f2cl-lib:fref drhox-%data% (j2 j2)
                               ((1 (f2cl-lib:int-mul 2 n))
                                (1 (f2cl-lib:int-mul 2 n)))
                               drhox-%offset%)
                  (f2cl-lib:fref drhox-%data% (j2m1 j2m1)
                                 ((1 (f2cl-lib:int-mul 2 n))
                                  (1 (f2cl-lib:int-mul 2 n)))
                                 drhox-%offset%))
          (setf (f2cl-lib:fref drhox-%data% (j2 j2m1)
                               ((1 (f2cl-lib:int-mul 2 n))
                                (1 (f2cl-lib:int-mul 2 n)))
                               drhox-%offset%)
                  (+
                   (f2cl-lib:fref drhox-%data% (j2 j2m1)
                                  ((1 (f2cl-lib:int-mul 2 n))
                                   (1 (f2cl-lib:int-mul 2 n)))
                                  drhox-%offset%)
                   (* oneml
                      (f2cl-lib:fref dg-%data% (2 j) ((1 2) (1 n))
                                     dg-%offset%))))
          (setf (f2cl-lib:fref drhox-%data% (j2m1 j2)
                               ((1 (f2cl-lib:int-mul 2 n))
                                (1 (f2cl-lib:int-mul 2 n)))
                               drhox-%offset%)
                  (-
                   (f2cl-lib:fref drhox-%data% (j2 j2m1)
                                  ((1 (f2cl-lib:int-mul 2 n))
                                   (1 (f2cl-lib:int-mul 2 n)))
                                  drhox-%offset%)))
          (setf (f2cl-lib:fref drhol-%data% (j2m1) ((1 (f2cl-lib:int-mul 2 n)))
                               drhol-%offset%)
                  (- (f2cl-lib:fref f-%data% (1 j) ((1 2) (1 n)) f-%offset%)
                     (f2cl-lib:fref g-%data% (1 j) ((1 2) (1 n)) g-%offset%)))
          (setf (f2cl-lib:fref drhol-%data% (j2) ((1 (f2cl-lib:int-mul 2 n)))
                               drhol-%offset%)
                  (- (f2cl-lib:fref f-%data% (2 j) ((1 2) (1 n)) f-%offset%)
                     (f2cl-lib:fref g-%data% (2 j) ((1 2) (1 n)) g-%offset%)))
          (setf (f2cl-lib:fref rho-%data% (j2m1) ((1 (f2cl-lib:int-mul 2 n)))
                               rho-%offset%)
                  (+
                   (* lambda$
                      (f2cl-lib:fref f-%data% (1 j) ((1 2) (1 n)) f-%offset%))
                   (* oneml
                      (f2cl-lib:fref g-%data% (1 j) ((1 2) (1 n))
                                     g-%offset%))))
          (setf (f2cl-lib:fref rho-%data% (j2) ((1 (f2cl-lib:int-mul 2 n)))
                               rho-%offset%)
                  (+
                   (* lambda$
                      (f2cl-lib:fref f-%data% (2 j) ((1 2) (1 n)) f-%offset%))
                   (* oneml
                      (f2cl-lib:fref g-%data% (2 j) ((1 2) (1 n))
                                     g-%offset%))))
         label30))
      (go end_label)
     end_label
  ...
  (setf (gethash 'fortran-to-lisp::hfun1p
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil nil nil nil nil nil
                                              ...
                                              nil nil nil)
                                            :calls
                                            '(fortran-to-lisp::ffunp
                                              fortran-to-lisp::gfunp))))
