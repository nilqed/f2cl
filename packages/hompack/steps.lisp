...
(let ((two
      ...
      (gstr
       (make-array 13 :element-type 'double-float :initial-contents
                   '(0.5d0 0.0833d0 0.0417d0 0.0264d0 0.0188d0 0.0143d0
  ...
  (declare (type f2cl-lib:logical phase1 nornd)
           (type (f2cl-lib:integer4) i ifail im1 ip1 iq j jv km1 km2 knew kp1
            kp2 kprev l limit1 limit2 ns nsm2 nsp1 nsp2)
           (type (double-float) absh erk erkm1 erkm2 erkp1 err fouru hnew p5eps
            r reali realns rho round$ sum tau temp1 temp2 temp3 temp4 temp5
            temp6 twou)
      ...
      (prog ()
                    ...
                    (+ round$
                       (expt
                        (/ (f2cl-lib:fref y-%data% (l) ((1 neqn)) y-%offset%)
                           (f2cl-lib:fref wt-%data% (l) ((1 neqn))
                                          wt-%offset%))
                        2)))))
       ...
       label15
        ...
        (multiple-value-bind
            ...
            (funcall f x y yp fpwa1 fpwa2 fpwa3 fpwa4 fpwa5 ifpwa1 ifpc1
                     (f2cl-lib:int-sub neqn 1) ifpc2 par ipar)
          (declare
           (ignore var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-10
            var-12 var-13))
          (when var-0 (setf x var-0))
          (when var-9 (setf ifpc1 var-9))
          (when var-11 (setf ifpc2 var-11)))
        (if (> ifpc2 0)
            (go end_label))
        ...
        (f2cl-lib:fdo (l 1 (f2cl-lib:int-add l 1))
                      ((> l neqn) nil)
          (tagbody
            (setf (f2cl-lib:fref phi-%data% (l 1) ((1 neqn) (1 16))
                                 phi-%offset%)
                    (f2cl-lib:fref yp-%data% (l) ((1 neqn)) yp-%offset%))
            (setf (f2cl-lib:fref phi-%data% (l 2) ((1 neqn) (1 16))
                                 phi-%offset%)
        ...
        (f2cl-lib:fdo (l 1 (f2cl-lib:int-add l 1))
          ...
          (tagbody
           label25
            (setf (f2cl-lib:fref phi-%data% (l 15) ((1 neqn) (1 16))
                                 phi-%offset%)
                    (coerce 0.0 'double-float))))
       label99
        (setf ifail 0)
       ...
       label120
        ...
        (setf jv
                (f2cl-lib:int-sub kp1
                                  (f2cl-lib:fref iv-%data% (ivc) ((1 10))
                                                 iv-%offset%)))
          ...
          (tagbody
            ...
            (setf (f2cl-lib:fref v (i) ((1 12)))
                    (- (f2cl-lib:fref v (i) ((1 12)))
                       (*
                        (f2cl-lib:fref alpha-%data% ((f2cl-lib:int-add j 1))
                                       ((1 12)) alpha-%offset%)
       ...
       label130
        ...
        (f2cl-lib:fdo (iq 1 (f2cl-lib:int-add iq 1))
          ...
          (tagbody
            (setf (f2cl-lib:fref v (iq) ((1 12)))
                    (- (f2cl-lib:fref v (iq) ((1 12)))
                       (* temp5
                          (f2cl-lib:fref v ((f2cl-lib:int-add iq 1))
                                         ((1 12))))))
           label135
            (setf (f2cl-lib:fref w-%data% (iq) ((1 12)) w-%offset%)
                    (f2cl-lib:fref v (iq) ((1 12))))))
        ...
        (setf (f2cl-lib:fref gi-%data% (kgi) ((1 11)) gi-%offset%)
                (f2cl-lib:fref w-%data% (2) ((1 12)) w-%offset%))
       label137
        (setf (f2cl-lib:fref w-%data% ((f2cl-lib:int-add limit1 1)) ((1 12))
                             w-%offset%)
       ...
       label140
        ...
        (f2cl-lib:fdo (i nsp2 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (setf temp6
                    (f2cl-lib:fref alpha-%data% ((f2cl-lib:int-sub i 1))
                                   ((1 12)) alpha-%offset%))
            (f2cl-lib:fdo (iq 1 (f2cl-lib:int-add iq 1))
                          ((> iq limit2) nil)
              (tagbody
               label145
                (setf (f2cl-lib:fref w-%data% (iq) ((1 12)) w-%offset%)
                        (- (f2cl-lib:fref w-%data% (iq) ((1 12)) w-%offset%)
                           (* temp6
                              (f2cl-lib:fref w-%data% ((f2cl-lib:int-add iq 1))
                                             ((1 12)) w-%offset%))))))
           label150
        ...
        (f2cl-lib:fdo (i nsp1 (f2cl-lib:int-add i 1))
          ...
          (tagbody
            ...
            (f2cl-lib:fdo (l 1 (f2cl-lib:int-add l 1))
              ...
              (tagbody
               label205
                (setf (f2cl-lib:fref phi-%data% (l i) ((1 neqn) (1 16))
                                     phi-%offset%)
                        (* temp1
                           (f2cl-lib:fref phi-%data% (l i) ((1 neqn) (1 16))
                                          phi-%offset%)))))
           label210))
       label215
        (f2cl-lib:fdo (l 1 (f2cl-lib:int-add l 1))
                      ((> l neqn) nil)
          (tagbody
            (setf (f2cl-lib:fref phi-%data% (l kp2) ((1 neqn) (1 16))
                                 phi-%offset%)
                    (f2cl-lib:fref phi-%data% (l kp1) ((1 neqn) (1 16))
                                   phi-%offset%))
            (setf (f2cl-lib:fref phi-%data% (l kp1) ((1 neqn) (1 16))
                                 phi-%offset%)
                    (coerce 0.0 'double-float))
           label220
               ...
               label225
                (setf (f2cl-lib:fref phi-%data% (l i) ((1 neqn) (1 16))
                        ...
                        (+
                         (f2cl-lib:fref phi-%data% (l i) ((1 neqn) (1 16))
                                        phi-%offset%)
                         (f2cl-lib:fref phi-%data% (l ip1) ((1 neqn) (1 16))
                                        phi-%offset%)))))
           label230))
        (if nornd
            (go label240))
          ...
          (tagbody
            (setf tau
                    (- (* h (f2cl-lib:fref p-%data% (l) ((1 neqn)) p-%offset%))
                       (f2cl-lib:fref phi-%data% (l 15) ((1 neqn) (1 16))
                                      phi-%offset%)))
            (setf (f2cl-lib:fref p-%data% (l) ((1 neqn)) p-%offset%)
                    (+ (f2cl-lib:fref y-%data% (l) ((1 neqn)) y-%offset%) tau))
           label235
            (setf (f2cl-lib:fref phi-%data% (l 16) ((1 neqn) (1 16))
                                 phi-%offset%)
                    (- (f2cl-lib:fref p-%data% (l) ((1 neqn)) p-%offset%)
                       (f2cl-lib:fref y-%data% (l) ((1 neqn)) y-%offset%)
                       tau))))
       ...
       label250
        ...
        (multiple-value-bind
            (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9 var-10
             var-11 var-12 var-13)
            (funcall f x p yp fpwa1 fpwa2 fpwa3 fpwa4 fpwa5 ifpwa1 ifpc1
                     (f2cl-lib:int-sub neqn 1) ifpc2 par ipar)
          (declare
           (ignore var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-10
            var-12 var-13))
        ...
        (f2cl-lib:fdo (l 1 (f2cl-lib:int-add l 1))
          ...
          (tagbody
            ...
            (setf temp4
                    (- (f2cl-lib:fref yp-%data% (l) ((1 neqn)) yp-%offset%)
                       (f2cl-lib:fref phi-%data% (l 1) ((1 neqn) (1 16))
                                      phi-%offset%)))
            (f2cl-lib:arithmetic-if km2 (go label265) (go label260)
                                    (go label255))
           label255
            (setf erkm2
                    (+ erkm2
                       (expt
                        (*
                         (+
                          (f2cl-lib:fref phi-%data% (l km1) ((1 neqn) (1 16))
                                         phi-%offset%)
                          temp4)
                         temp3)
                        2)))
            ...
            (setf erkm1
                    (+ erkm1
                       (expt
                        (*
                         (+
                          (f2cl-lib:fref phi-%data% (l k) ((1 neqn) (1 16))
                                         phi-%offset%)
                          temp4)
                         temp3)
                        2)))
       ...
       label270
        (setf erkm2
                (* absh (f2cl-lib:fref sig (km1) ((1 13)))
                   (f2cl-lib:fref gstr (km2) ((1 13))) (f2cl-lib:fsqrt erkm2)))
       label275
        (setf erkm1
                (* absh (f2cl-lib:fref sig (k) ((1 13)))
                   (f2cl-lib:fref gstr (km1) ((1 13))) (f2cl-lib:fsqrt erkm1)))
       label280
        ...
        (setf erk
                (* temp5 (f2cl-lib:fref sig (kp1) ((1 13)))
       ...
       label320
        ...
        (f2cl-lib:arithmetic-if (f2cl-lib:int-sub ifail 3) (go label335)
                                (go label330) (go label325))
       label325
        (if (< p5eps (* 0.25 erk))
                    ...
                    (-
                     (* temp1
                        (- (f2cl-lib:fref yp-%data% (l) ((1 neqn)) yp-%offset%)
                           (f2cl-lib:fref phi-%data% (l 1) ((1 neqn) (1 16))
                                          phi-%offset%)))
                     (f2cl-lib:fref phi-%data% (l 16) ((1 neqn) (1 16))
                                    phi-%offset%)))
           ...
           label425
            (setf (f2cl-lib:fref phi-%data% (l kp2) ((1 neqn) (1 16))
                    ...
                    (-
                     (f2cl-lib:fref phi-%data% (l kp1) ((1 neqn) (1 16))
                                    phi-%offset%)
                     (f2cl-lib:fref phi-%data% (l kp2) ((1 neqn) (1 16))
                                    phi-%offset%)))))
        (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                      ((> i k) nil)
          (tagbody
            ...
            (setf erkp1
                    (+ erkp1
                       (expt
                        ...
                        2)))))
        (setf erkp1
                (* absh (f2cl-lib:fref gstr (kp1) ((1 13)))
       ...
       end_label
        (return
         (values nil nil nil x h eps nil start hold k kold crash nil nil nil
                 nil nil nil ksteps xold ivc nil kgi nil nil nil nil nil nil
                 nil ifpc1 ifpc2 nil nil))))))
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            '(t (fortran-to-lisp::integer4)
                                              ...
                                              (array fortran-to-lisp::integer4
                                               (*)))
                                            :return-values
                                            '(nil nil nil fortran-to-lisp::x
                                              fortran-to-lisp::h
                                              fortran-to-lisp::eps nil
                                              fortran-to-lisp::start
                                              fortran-to-lisp::hold
                                              fortran-to-lisp::k
                                              fortran-to-lisp::kold
                                              fortran-to-lisp::crash nil nil
                                              nil nil nil nil
                                              fortran-to-lisp::ksteps
                                              fortran-to-lisp::xold
                                              fortran-to-lisp::ivc nil
                                              fortran-to-lisp::kgi nil nil nil
                                              nil nil nil nil
                                              fortran-to-lisp::ifpc1
                                              fortran-to-lisp::ifpc2 nil nil)
