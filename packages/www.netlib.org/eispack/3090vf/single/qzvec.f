...
c"    ( prefer vector
            do 760 j = m, en
               foo = betm * a(i,j) - almr * b(i,j)
               foo2 = -almi * b(i,j)
               ra = ra + foo * b(j,na) - foo2 * b(j,en)
               sa = sa + foo * b(j,en) + foo2 * b(j,na)
  760       continue
c
