...
c
      integer i,j,k,l,m,n,en,na,nm,
     x        igh,itn,its,low,enm2,ierr
      real h(nm,n),wr(n),wi(n),z(nm,n)
      real p,q,r,s,t,w,x,y,ra,sa,vi,vr,zz,norm,tst1,tst2,foo
      logical notlas
c
...
c     .......... accumulate transformations ..........
         do 220 i = low, igh
            foo = x * z(i,k) + y * z(i,k+1)
            z(i,k) = z(i,k) - foo
            z(i,k+1) = z(i,k+1) - foo * q
  220    continue
         go to 255
  225    continue
c     .......... row modification ..........
...
c     .......... accumulate transformations ..........
         do 250 i = low, igh
            foo = x * z(i,k) + y * z(i,k+1) + zz * z(i,k+2)
            z(i,k) = z(i,k) - foo
            z(i,k+1) = z(i,k+1) - foo * q
            z(i,k+2) = z(i,k+2) - foo * r
  250    continue
  255    continue
c
  260 continue
...
c"    ( prefer vector
      do 290 j = na, n
         foo = h(na,j)
         h(na,j) = q * foo + p * h(en,j)
         h(en,j) = q * h(en,j) - p * foo
  290 continue
c     .......... column modification ..........
      do 300 i = 1, en
         foo = h(i,na)
         h(i,na) = q * foo + p * h(i,en)
         h(i,en) = q * h(i,en) - p * foo
  300 continue
c     .......... accumulate transformations ..........
      do 310 i = low, igh
         foo = z(i,na)
         z(i,na) = q * foo + p * z(i,en)
         z(i,en) = q * z(i,en) - p * foo
  310 continue
c
      go to 330
c     .......... complex pair ..........
