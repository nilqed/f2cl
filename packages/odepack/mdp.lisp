...
(defun mdp (k ek tail v l head last$ next mark)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((tag 0) (free 0) (li 0) (vi 0) (lvi 0) (evi 0) (s 0) (ls 0) (es 0)
           (ilp 0) (ilpmax 0) (i 0))
      (declare
       (type (f2cl-lib:integer4) i ilpmax ilp es ls s evi lvi vi li free tag))
      ...
      (f2cl-lib:fdo (ilp 1 (f2cl-lib:int-add ilp 1))
        ...
        (tagbody
          ...
          (go label2)
         label1
          (setf (f2cl-lib:fref next-%data% ((f2cl-lib:fref last$ (vi) ((1 *))))
                               ((1 *)) next-%offset%)
                  (f2cl-lib:fref next-%data% (vi) ((1 *)) next-%offset%))
         label2
          (if (> (f2cl-lib:fref next-%data% (vi) ((1 *)) next-%offset%) 0)
              (setf (f2cl-lib:fref last$-%data%
                                   ((f2cl-lib:fref next (vi) ((1 *)))) ((1 *))
                                   last$-%offset%)
                      (f2cl-lib:fref last$-%data% (vi) ((1 *))
                                     last$-%offset%)))
         label3
          (setf ls vi)
         label4
         ...
         label6
          ...
          (setf (f2cl-lib:fref last$-%data% (ek) ((1 *)) last$-%offset%)
                  (f2cl-lib:int-sub
                   (f2cl-lib:fref last$-%data% (ek) ((1 *)) last$-%offset%) 1))
          (go label11)
         label7
         ...
         label8
          ...
          (setf (f2cl-lib:fref mark-%data% (evi) ((1 *)) mark-%offset%)
                  (f2cl-lib:int-sub
                   (f2cl-lib:fref mark-%data% (evi) ((1 *)) mark-%offset%) 1))
          (go label10)
         label9
  ...
  (setf (gethash 'fortran-to-lisp::mdp fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(fortran-to-lisp::k nil
                                              fortran-to-lisp::tail nil nil nil
                                              nil nil nil)
                                            :calls 'nil)))
