    ...
    (prog ((ak 0.0d0) (jak 0) (jdummy 0) (ilast 0) (k 0) (j 0) (jmax 0)
      ...
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
          ...
          (setf jmax
                  (f2cl-lib:int-sub
                   (f2cl-lib:fref ia-%data% ((f2cl-lib:int-add i 1)) ((1 *))
                                  ia-%offset%)
                   1))
          (if (> jmin jmax)
              (go label3))
          (f2cl-lib:fdo (j jmin (f2cl-lib:int-add j 1))
            ...
            (tagbody
              ...
              (if (< (f2cl-lib:fref ip-%data% (k) ((1 *)) ip-%offset%)
             ...
             label2
              (setf (f2cl-lib:fref q-%data% (k) ((1 *)) q-%offset%)
                      (f2cl-lib:int-add
                       (f2cl-lib:fref q-%data% (k) ((1 *)) q-%offset%) 1))))
         label3))
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                    ((> i n) nil)
        (tagbody
          (setf (f2cl-lib:fref ia-%data% ((f2cl-lib:int-add i 1)) ((1 *))
                               ia-%offset%)
                  (f2cl-lib:int-add
      ...
      (setf jmax
              (f2cl-lib:int-sub
               (f2cl-lib:fref ia-%data% ((f2cl-lib:int-add n 1)) ((1 *))
                              ia-%offset%)
               1))
      (setf j jmax)
      (f2cl-lib:fdo (jdummy jmin (f2cl-lib:int-add jdummy 1))
        ...
        (tagbody
         ...
         label5
          (setf (f2cl-lib:fref q-%data% (i) ((1 *)) q-%offset%)
                  (f2cl-lib:int-sub
                   (f2cl-lib:fref q-%data% (i) ((1 *)) q-%offset%) 1))
          (setf (f2cl-lib:fref r-%data% (j) ((1 *)) r-%offset%)
                  (f2cl-lib:fref q-%data% (i) ((1 *)) q-%offset%))
         label6
