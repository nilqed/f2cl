  ...
  (f2cl-lib:with-multi-array-data
    ...
    (symbol-macrolet ((vs es))
      (prog ((tag 0) (vi 0) (evi 0) (dvi 0) (s 0) (es 0) (b 0) (vb 0) (ilp 0)
        ...
        (declare
         (type (f2cl-lib:integer4) i blpmax blp ilpmax ilp vb b es vs s dvi evi
          vi tag))
        (setf tag
                (f2cl-lib:int-sub
        ...
        (f2cl-lib:fdo (ilp 1 (f2cl-lib:int-add ilp 1))
          ...
          (tagbody
            ...
            (f2cl-lib:arithmetic-if
             ...
             (go label1) (go label10) (go label8))
           label1
           ...
           label3
            ...
            (f2cl-lib:fdo (blp 1 (f2cl-lib:int-add blp 1))
              ...
              (tagbody
                ...
                (if (>= (f2cl-lib:fref mark-%data% (vb) ((1 *)) mark-%offset%)
                        tag)
                    (go label4))
           ...
           label6
            ...
            (setf (f2cl-lib:fref mark-%data% (es) ((1 *)) mark-%offset%)
                    (f2cl-lib:int-sub
                     (f2cl-lib:fref mark-%data% (es) ((1 *)) mark-%offset%) 1))
           label7
            (setf s (f2cl-lib:fref l-%data% (s) ((1 *)) l-%offset%))
            (if (= s 0)
                (go label10))
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            '((fortran-to-lisp::integer4)
                                              ...
                                              (array fortran-to-lisp::integer4
                                               (*)))
                                            :return-values
                                            '(nil fortran-to-lisp::dmin nil nil
                                              nil nil nil nil)
                                            :calls 'nil)))
