  ...
  (defun cdrv (n r c ic ia ja a b z nsp isp rsp esp path flag)
    ...
    (f2cl-lib:with-multi-array-data
      ...
      (prog ((d 0) (u 0) (q 0) (row 0) (tmp 0) (ar 0) (umax 0) (lmax 0) (l 0)
        ...
        (declare
         (type (f2cl-lib:integer4) il ijl iu iju irl jrl jl max jlmax ira jra
          irac iru jru jutmp jumax i ju j l lmax umax ar tmp row q u d))
        (if (or (< path 1) (< 5 path))
            (go label111))
        (setf il 1)
        ...
        (setf max
                (f2cl-lib:int-sub
                 (f2cl-lib:int-add (f2cl-lib:int-mul lratio nsp) 1) jl
                 (f2cl-lib:int-add n 1) (f2cl-lib:int-mul 5 n)))
        ...
        (setf jumax
                (f2cl-lib:int-sub
                 (f2cl-lib:int-add (f2cl-lib:int-mul lratio nsp) 1) jutmp))
        (setf esp (the f2cl-lib:integer4 (truncate max lratio)))
        (if (or (<= jlmax 0) (<= jumax 0))
            (go label110))
       ...
       label2
        ...
        (multiple-value-bind
            ...
            (nroc n ic ia ja a
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (il) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice rsp-%data% double-float (ar) ((1 *))
                                   rsp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (iu) ((1 *))
                                   isp-%offset%)
             flag)
       ...
       label3
        (multiple-value-bind
            ...
            (nsfc n r ic ia ja jlmax
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (il) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (jl) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (ijl) ((1 *))
                                   isp-%offset%)
             jumax
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (iu) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (jutmp) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (iju) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (q) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (ira) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (jra) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (irac) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (irl) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (jrl) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (iru) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (jru) ((1 *))
                                   isp-%offset%)
             flag)
          (declare
       ...
       label5
        ...
        (setf lmax
                (f2cl-lib:int-sub
                 (f2cl-lib:fref isp-%data% ((f2cl-lib:int-add il n)) ((1 *))
                                isp-%offset%)
                 1))
        ...
        (multiple-value-bind
            ...
            (nnfc n r c ic ia ja a z b lmax
             ...
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (ijl) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice rsp-%data% double-float (l) ((1 *))
                                   rsp-%offset%)
             (f2cl-lib:array-slice rsp-%data% double-float (d) ((1 *))
                                   rsp-%offset%)
             umax
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (iu) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (ju) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (iju) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice rsp-%data% double-float (u) ((1 *))
                                   rsp-%offset%)
             (f2cl-lib:array-slice rsp-%data% double-float (row) ((1 *))
                                   rsp-%offset%)
             (f2cl-lib:array-slice rsp-%data% double-float (tmp) ((1 *))
                                   rsp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (irl) ((1 *))
                                   isp-%offset%)
             (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (jrl) ((1 *))
       ...
       end_label
        (return
         (values nil nil nil nil nil nil nil nil nil nil nil nil esp nil
                 flag))))))
  ...
  (setf (gethash 'fortran-to-lisp::cdrv fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil nil nil nil nil nil
                                              nil nil nil nil
                                              fortran-to-lisp::esp nil
                                              fortran-to-lisp::flag)
                                            :calls
                                            '(fortran-to-lisp::nntc
                                              fortran-to-lisp::nnsc
                                              fortran-to-lisp::nnfc
                                              fortran-to-lisp::nsfc
