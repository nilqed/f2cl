...
(defun nnfc
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((lki 0.0d0) (sum 0.0d0) (dk 0.0d0) (rk 0) (ijlb 0) (mu 0) (j 0)
      ...
      (if (>
           (f2cl-lib:int-sub
            (f2cl-lib:fref il-%data% ((f2cl-lib:int-add n 1)) ((1 *))
                           il-%offset%)
            1)
           lmax)
          (go label104))
      (if (>
           (f2cl-lib:int-sub
            (f2cl-lib:fref iu-%data% ((f2cl-lib:int-add n 1)) ((1 *))
                           iu-%offset%)
            1)
           umax)
          (go label107))
        ...
        (tagbody
         ...
         label3
                  ...
                  (f2cl-lib:int-sub
                   (f2cl-lib:int-add jmin
                                     (f2cl-lib:fref iu-%data%
                                                    ...
                                                    ((1 *)) iu-%offset%))
                   (f2cl-lib:fref iu-%data% (k) ((1 *)) iu-%offset%) 1))
          (if (> jmin jmax)
              (go label5))
          (f2cl-lib:fdo (j jmin (f2cl-lib:int-add j 1))
            ...
            (tagbody
             label4
              (setf (f2cl-lib:fref row-%data% ((f2cl-lib:fref ju (j) ((1 *))))
                                   ((1 *)) row-%offset%)
                      (coerce (the f2cl-lib:integer4 0) 'double-float))))
         label5
         ...
         label7
          ...
          (setf (f2cl-lib:fref l-%data% ((f2cl-lib:fref irl (i) ((1 *))))
                               ((1 *)) l-%offset%)
                  (- lki))
          (setf sum
                  (+ sum
          ...
          (setf mu
                  (f2cl-lib:int-sub
                   (f2cl-lib:fref iju-%data% (i) ((1 *)) iju-%offset%) jmin))
          (f2cl-lib:fdo (j jmin (f2cl-lib:int-add j 1))
                        ((> j jmax) nil)
            (tagbody
             label8
              (setf (f2cl-lib:fref row-%data%
                                   ((f2cl-lib:fref ju ((f2cl-lib:int-add mu j))
                                                   ((1 *))))
                                   ((1 *)) row-%offset%)
                      (+
         ...
         label10
          ...
          (setf jmax
                  (f2cl-lib:int-sub
                   (f2cl-lib:fref iu-%data% ((f2cl-lib:int-add k 1)) ((1 *))
                                  iu-%offset%)
                   1))
          (if (> jmin jmax)
              (go label12))
          (setf mu
                  (f2cl-lib:int-sub
                   (f2cl-lib:fref iju-%data% (k) ((1 *)) iju-%offset%) jmin))
          (f2cl-lib:fdo (j jmin (f2cl-lib:int-add j 1))
                        ((> j jmax) nil)
            (tagbody
             label11
         ...
         label14
          ...
          (if (>= (f2cl-lib:fref irl-%data% (i) ((1 *)) irl-%offset%)
         ...
         label17
          ...
          (if (/= i 0)
              (go label14))
         label18
          (if (>= (f2cl-lib:fref irl-%data% (k) ((1 *)) irl-%offset%)
                  (f2cl-lib:fref il-%data% ((f2cl-lib:int-add k 1)) ((1 *))
                                 il-%offset%))
              (go label19))
          (setf j
                  (f2cl-lib:fref jl-%data% ((f2cl-lib:fref ijl (k) ((1 *))))
                                 ((1 *)) jl-%offset%))
      ...
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
         ...
         label21
          ...
          (setf (f2cl-lib:fref z-%data% ((f2cl-lib:fref c (k) ((1 *)))) ((1 *))
                               z-%offset%)
                  sum)
         label22
     ...
     end_label
      (return
       (values nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil
               nil nil nil nil nil nil nil nil flag)))))
