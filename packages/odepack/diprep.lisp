...
(defstruct (dls001 (:predicate is-dls001-p))
  (part-0 (make-array 218 :element-type 'double-float) :type
   (simple-array double-float (218)))
  (part-1 (make-array 37 :element-type 'f2cl-lib:integer4) :type
   (simple-array f2cl-lib:integer4 (37))))
...
(defstruct (dlss01 (:predicate is-dlss01-p))
  (part-0 (make-array 6 :element-type 'double-float) :type
   (simple-array double-float (6)))
  (part-1 (make-array 34 :element-type '(f2cl-lib:integer4)) :type
   (simple-array (f2cl-lib:integer4) (34))))
      ...
      (f2cl-lib:with-multi-array-data
        ...
        (prog ((lyhn 0) (lyhd 0) (lewtn 0) (imax 0) (i 0))
          ...
          (multiple-value-bind
              ...
              (dprep neq y
               (f2cl-lib:array-slice rwork-%data% double-float (lyh) ((1 *))
                                     rwork-%offset%)
               (f2cl-lib:array-slice rwork-%data% double-float (lsavf) ((1 *))
                                     rwork-%offset%)
               (f2cl-lib:array-slice rwork-%data% double-float (lewt) ((1 *))
                                     rwork-%offset%)
               (f2cl-lib:array-slice rwork-%data% double-float (lacor) ((1 *))
                                     rwork-%offset%)
               ia ja
               (f2cl-lib:array-slice rwork-%data% double-float (lwm) ((1 *))
                                     rwork-%offset%)
               (f2cl-lib:array-slice rwork-%data% double-float (lwm) ((1 *))
                                     rwork-%offset%)
               ipflag f jac)
            ...
            (tagbody
             label10
              (setf (f2cl-lib:fref rwork-%data% (i) ((1 *)) rwork-%offset%)
                      (f2cl-lib:fref rwork-%data% ((f2cl-lib:int-add i lyhd))
                                     ((1 *)) rwork-%offset%))))
          (setf lyh lyhn)
         label20
            ...
            (tagbody
             label30
              (setf (f2cl-lib:fref rwork-%data%
                                   ((f2cl-lib:int-sub
                                     (f2cl-lib:int-add i lewtn) 1))
                                   ((1 *)) rwork-%offset%)
                      (f2cl-lib:fref rwork-%data%
                                     ((f2cl-lib:int-sub
                                       (f2cl-lib:int-add i lewt) 1))
                                     ((1 *)) rwork-%offset%))))
         label40
          (setf lewt lewtn)
          (go end_label)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::diprep
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            :return-values
                                            '(nil nil nil nil nil
                                              fortran-to-lisp::ipflag nil nil)
