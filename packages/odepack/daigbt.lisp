  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((i 0) (lenpw 0) (lblox 0) (lpb 0) (lpc 0))
      ...
      (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7)
          (funcall adda neq t$ y mb nb
                   (f2cl-lib:array-slice pw-%data% double-float (1) ((1 *))
                                         pw-%offset%)
                   (f2cl-lib:array-slice pw-%data% double-float (lpb) ((1 *))
                                         pw-%offset%)
                   (f2cl-lib:array-slice pw-%data% double-float (lpc) ((1 *))
                                         pw-%offset%))
        (declare (ignore var-0 var-2 var-5 var-6 var-7))
        (when var-1 (setf t$ var-1))
        (when var-3 (setf mb var-3))
        (when var-4 (setf nb var-4)))
  ...
  (setf (gethash 'fortran-to-lisp::daigbt
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil fortran-to-lisp::t$
                                              nil nil fortran-to-lisp::mb
                                              fortran-to-lisp::nb nil nil
                                              fortran-to-lisp::ier)
                                            :calls
                                            '(fortran-to-lisp::dsolbt
