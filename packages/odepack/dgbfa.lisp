...
(defun dgbfa (abd lda n ml mu ipvt info)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((i 0) (i0 0) (j 0) (ju 0) (jz 0) (j0 0) (j1 0) (k 0) (kp1 0) (l 0)
      ...
      (setf j1
              (f2cl-lib:int-sub
               (min (the f2cl-lib:integer4 n) (the f2cl-lib:integer4 m)) 1))
      (if (< j1 j0)
          (go label30))
      (f2cl-lib:fdo (jz j0 (f2cl-lib:int-add jz 1))
        ...
        (tagbody
          ...
          (f2cl-lib:fdo (i i0 (f2cl-lib:int-add i 1))
                        ((> i ml) nil)
            (tagbody
              (setf (f2cl-lib:fref abd-%data% (i jz) ((1 lda) (1 *))
                                   abd-%offset%)
                      0.0d0)
             label10))
         label20))
      ...
      (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
        ...
        (tagbody
         ...
         label50
                  ...
                  (f2cl-lib:int-sub
                   (f2cl-lib:int-add
                    (idamax (f2cl-lib:int-add lm 1)
                     (f2cl-lib:array-slice abd-%data% double-float (m k)
                                           ((1 lda) (1 *)) abd-%offset%)
                     1)
                    m)
                   1))
          ...
          (if (= (f2cl-lib:fref abd-%data% (l k) ((1 lda) (1 *)) abd-%offset%)
                 0.0d0)
              (go label100))
          (if (= l m)
              (go label60))
          (setf t$
                  (f2cl-lib:fref abd-%data% (l k) ((1 lda) (1 *))
                                 abd-%offset%))
          (setf (f2cl-lib:fref abd-%data% (l k) ((1 lda) (1 *)) abd-%offset%)
                  (f2cl-lib:fref abd-%data% (m k) ((1 lda) (1 *))
                                 abd-%offset%))
         ...
         label60
          (setf t$
                  (/ -1.0d0
                     (f2cl-lib:fref abd-%data% (m k) ((1 lda) (1 *))
                                    abd-%offset%)))
          (dscal lm t$
           (f2cl-lib:array-slice abd-%data% double-float ((+ m 1) k)
                                 ((1 lda) (1 *)) abd-%offset%)
           1)
          (setf ju
                  (min
          ...
          (f2cl-lib:fdo (j kp1 (f2cl-lib:int-add j 1))
            ...
            (tagbody
              ...
              (setf t$
                      (f2cl-lib:fref abd-%data% (l j) ((1 lda) (1 *))
                                     abd-%offset%))
              (if (= l mm)
                  (go label70))
              (setf (f2cl-lib:fref abd-%data% (l j) ((1 lda) (1 *))
                                   abd-%offset%)
                      (f2cl-lib:fref abd-%data% (mm j) ((1 lda) (1 *))
                                     abd-%offset%))
              (setf (f2cl-lib:fref abd-%data% (mm j) ((1 lda) (1 *))
                                   abd-%offset%)
                      t$)
             label70
              (daxpy lm t$
               (f2cl-lib:array-slice abd-%data% double-float ((+ m 1) k)
                                     ((1 lda) (1 *)) abd-%offset%)
               1
               (f2cl-lib:array-slice abd-%data% double-float ((+ mm 1) j)
                                     ((1 lda) (1 *)) abd-%offset%)
               1)
             label80))
         label90
     ...
     label130
      ...
      (if (= (f2cl-lib:fref abd-%data% (m n) ((1 lda) (1 *)) abd-%offset%)
             0.0d0)
          (setf info n))
      (go end_label)
     end_label
