...
(defun nsfc
       (n r ic ia ja jlmax il jl ijl jumax iu ju iju q ira jra irac irl jrl iru
        jru flag)
  (declare
   (type (array f2cl-lib:integer4 (*)) jru iru jrl irl irac jra ira q iju ju iu
    ijl jl il ja ia ic r)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((cend 0) (qm 0) (rend 0) (rk 0) (vj 0) (jairai 0) (irai 0) (irul 0)
      ...
      (declare
       (type (f2cl-lib:integer4) np1 jlmin jlptr jumin juptr k iak jaiak luk m
        lastid lasti i jmin jmax long jtmp j irll i1 irul irai jairai vj rk
        rend qm cend))
      ...
      (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
        ...
        (tagbody
          ...
          (if (>= iak
                  (f2cl-lib:fref ia-%data% ((f2cl-lib:int-add rk 1)) ((1 *))
                                 ia-%offset%))
              (go label101))
          (setf jaiak
                  (f2cl-lib:fref ic-%data% ((f2cl-lib:fref ja (iak) ((1 *))))
                                 ((1 *)) ic-%offset%))
          (if (> jaiak k)
              (go label105))
        ...
        (tagbody
          ...
          (setf jmax
                  (f2cl-lib:int-sub
                   (f2cl-lib:int-add
                    ...
                    (f2cl-lib:fref il-%data% ((f2cl-lib:int-add i 1)) ((1 *))
                                   il-%offset%))
                   (f2cl-lib:fref il-%data% (i) ((1 *)) il-%offset%) 1))
         ...
         label10
          ...
          (if (/= (f2cl-lib:fref jl-%data% (irll) ((1 *)) jl-%offset%) k)
              (setf (f2cl-lib:fref ijl-%data% (k) ((1 *)) ijl-%offset%)
                      (f2cl-lib:int-sub
                       (f2cl-lib:fref ijl-%data% (k) ((1 *)) ijl-%offset%) 1)))
          (go label17)
         label11
          (if (> jlmin jlptr)
              (go label15))
          ...
          (f2cl-lib:fdo (j jlmin (f2cl-lib:int-add j 1))
            ...
            (tagbody
              (f2cl-lib:arithmetic-if
               (f2cl-lib:int-sub
                (f2cl-lib:fref jl-%data% (j) ((1 *)) jl-%offset%) qm)
               (go label12) (go label13) (go label15))
             label12))
          (go label15)
         label13
         ...
         label17
          ...
          (setf (f2cl-lib:fref il-%data% ((f2cl-lib:int-add k 1)) ((1 *))
                               il-%offset%)
                  (f2cl-lib:int-add
                   (f2cl-lib:fref il-%data% (k) ((1 *)) il-%offset%) luk))
          (setf (f2cl-lib:fref q-%data% (np1) ((1 *)) q-%offset%) np1)
          (setf luk -1)
          (setf rk (f2cl-lib:fref r-%data% (k) ((1 *)) r-%offset%))
          ...
          (f2cl-lib:fdo (j jmin (f2cl-lib:int-add j 1))
            ...
            (tagbody
              (setf vj
                      (f2cl-lib:fref ic-%data% ((f2cl-lib:fref ja (j) ((1 *))))
                                     ((1 *)) ic-%offset%))
              (setf qm np1)
             label18
              (setf m qm)
         ...
         label21
          ...
          (setf jmax
                  (f2cl-lib:int-sub
                   (f2cl-lib:int-add
                    ...
                    (f2cl-lib:fref iu-%data% ((f2cl-lib:int-add i 1)) ((1 *))
                                   iu-%offset%))
                   (f2cl-lib:fref iu-%data% (i) ((1 *)) iu-%offset%) 1))
          (setf long (f2cl-lib:int-sub jmax jmin))
          (if (< long 0)
              (go label21))
          ...
          (setf (f2cl-lib:fref irl-%data% (i) ((1 *)) irl-%offset%)
                  (f2cl-lib:int-add
                   (f2cl-lib:fref irl-%data% (i) ((1 *)) irl-%offset%) 1))
          (if (>= (f2cl-lib:fref irl-%data% (i) ((1 *)) irl-%offset%) cend)
              (go label22))
          (setf j
                  (f2cl-lib:fref jl-%data% ((f2cl-lib:fref irl (i) ((1 *))))
                                 ((1 *)) jl-%offset%))
         ...
         label26
          (if (<=
               (f2cl-lib:fref il-%data% ((f2cl-lib:int-add k 1)) ((1 *))
                              il-%offset%)
               (f2cl-lib:fref il-%data% (k) ((1 *)) il-%offset%))
              (go label27))
          (setf j
                  (f2cl-lib:fref jl-%data% ((f2cl-lib:fref irl (k) ((1 *))))
                                 ((1 *)) jl-%offset%))
         ...
         label27
          ...
          (if (/= (f2cl-lib:fref ju-%data% (irul) ((1 *)) ju-%offset%) k)
              (setf (f2cl-lib:fref iju-%data% (k) ((1 *)) iju-%offset%)
                      (f2cl-lib:int-sub
                       (f2cl-lib:fref iju-%data% (k) ((1 *)) iju-%offset%) 1)))
          (go label34)
         label28
          (if (> jumin juptr)
              (go label32))
          ...
          (f2cl-lib:fdo (j jumin (f2cl-lib:int-add j 1))
            ...
            (tagbody
              (f2cl-lib:arithmetic-if
               (f2cl-lib:int-sub
                (f2cl-lib:fref ju-%data% (j) ((1 *)) ju-%offset%) qm)
               (go label29) (go label30) (go label32))
             label29))
          (go label32)
         label30
         ...
         label34
          ...
          (setf (f2cl-lib:fref iu-%data% ((f2cl-lib:int-add k 1)) ((1 *))
                               iu-%offset%)
                  (f2cl-lib:int-add
                   (f2cl-lib:fref iu-%data% (k) ((1 *)) iu-%offset%) luk))
          (setf i k)
         label35
          ...
          (if (>= (f2cl-lib:fref iru-%data% (i) ((1 *)) iru-%offset%) rend)
              (go label37))
          (setf j
                  (f2cl-lib:fref ju-%data% ((f2cl-lib:fref iru (i) ((1 *))))
                                 ((1 *)) ju-%offset%))
         ...
         label37
          ...
          (setf (f2cl-lib:fref iru-%data% (i) ((1 *)) iru-%offset%)
                  (f2cl-lib:int-add
                   (f2cl-lib:fref iru-%data% (i) ((1 *)) iru-%offset%) 1))
          (go label35)
         label38
         ...
         label39
          ...
          (setf (f2cl-lib:fref ira-%data% (i) ((1 *)) ira-%offset%)
                  (f2cl-lib:int-add
                   (f2cl-lib:fref ira-%data% (i) ((1 *)) ira-%offset%) 1))
          (if (>= (f2cl-lib:fref ira-%data% (i) ((1 *)) ira-%offset%)
                  (f2cl-lib:fref ia-%data%
                                 ((f2cl-lib:int-add
                                   (f2cl-lib:fref r (i) ((1 *))) 1))
                                 ((1 *)) ia-%offset%))
              (go label40))
          (setf irai (f2cl-lib:fref ira-%data% (i) ((1 *)) ira-%offset%))
          (setf jairai
                  (f2cl-lib:fref ic-%data% ((f2cl-lib:fref ja (irai) ((1 *))))
                                 ((1 *)) ic-%offset%))
          (if (> jairai i)
              (go label40))
     ...
     end_label
      (return
       (values nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil nil
               nil nil nil nil nil flag)))))
