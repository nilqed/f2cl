  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((i 0) (lenpw 0) (mlp1 0) (nrowpw 0) (itemp 0))
     ...
     label100
      ...
      (setf lenpw
              (f2cl-lib:int-mul
               (f2cl-lib:fref neq-%data% (1) ((1 1)) neq-%offset%) nrowpw))
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                    ((> i lenpw) nil)
        (tagbody
         label110
      ...
      (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5 var-6)
          (funcall adda neq t$ y ml mu
                   (f2cl-lib:array-slice pw-%data% double-float (mlp1) ((1 *))
                                         pw-%offset%)
                   nrowpw)
        (declare (ignore var-0 var-2 var-5))
        (when var-1 (setf t$ var-1))
        (when var-3 (setf ml var-3))
        (when var-4 (setf mu var-4))
        (when var-6 (setf nrowpw var-6)))
      (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5 var-6)
  ...
  (setf (gethash 'fortran-to-lisp::dainvg
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            '(t t
                                              ...
                                              (fortran-to-lisp::integer4))
                                            :return-values
                                            '(nil nil nil fortran-to-lisp::t$
                                              nil nil nil fortran-to-lisp::ml
                                              fortran-to-lisp::mu nil nil
                                              fortran-to-lisp::ier)
                                            :calls
                                            '(fortran-to-lisp::dgbsl
                                              fortran-to-lisp::dgbfa
