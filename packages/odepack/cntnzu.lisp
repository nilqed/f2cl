    ...
    (prog ((ii 0) (jj 0) (j 0) (jmin 0) (jmax 0) (k 0) (kmin 0) (kmax 0)
      ...
      (f2cl-lib:fdo (ii 1 (f2cl-lib:int-add ii 1))
        ...
        (tagbody
          ...
          (setf jmax
                  (f2cl-lib:int-sub
                   (f2cl-lib:fref ia-%data% ((f2cl-lib:int-add ii 1)) ((1 *))
                                  ia-%offset%)
                   1))
          (if (> jmin jmax)
              (go label50))
          (f2cl-lib:fdo (j jmin (f2cl-lib:int-add j 1))
            ...
            (tagbody
              (f2cl-lib:arithmetic-if
               (f2cl-lib:int-sub
                (f2cl-lib:fref ja-%data% (j) ((1 *)) ja-%offset%) ii)
               (go label10) (go label40) (go label30))
             label10
              (setf jj (f2cl-lib:fref ja-%data% (j) ((1 *)) ja-%offset%))
              (setf kmin (f2cl-lib:fref ia-%data% (jj) ((1 *)) ia-%offset%))
              (setf kmax
                      (f2cl-lib:int-sub
                       (f2cl-lib:fref ia-%data% ((f2cl-lib:int-add jj 1))
                                      ((1 *)) ia-%offset%)
                       1))
              (if (> kmin kmax)
                  (go label30))
