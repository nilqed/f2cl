    ...
    (prog ((j 0) (k 0) (km1 0) (kp1 0) (l 0) (nm1 0) (t$ 0.0d0))
      ...
      (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
        ...
        (tagbody
          ...
          (if (= (f2cl-lib:fref a-%data% (l k) ((1 lda) (1 *)) a-%offset%)
                 0.0d0)
              (go label40))
          (if (= l k)
              (go label10))
          ...
          (setf t$
                  (/ -1.0d0
                     (f2cl-lib:fref a-%data% (k k) ((1 lda) (1 *))
                                    a-%offset%)))
          (setf (f2cl-lib:fref a-%data% ((f2cl-lib:int-add k 1) k)
                               ((1 lda) (1 *)) a-%offset%)
                  (*
                   (f2cl-lib:fref a-%data% ((f2cl-lib:int-add k 1) k)
                                  ((1 lda) (1 *)) a-%offset%)
                   t$))
         ...
         label90
          (setf (f2cl-lib:fref a-%data% (k n) ((1 lda) (1 *)) a-%offset%)
                  (+ (f2cl-lib:fref a-%data% (k n) ((1 lda) (1 *)) a-%offset%)
                     (*
                      (f2cl-lib:fref a-%data% (k km1) ((1 lda) (1 *))
                                     a-%offset%)
                      t$)))
         label100))
     label105
      ...
      (setf l
              (f2cl-lib:int-sub
               (f2cl-lib:int-add
                (idamax 2
                 (f2cl-lib:array-slice a-%data% double-float (nm1 nm1)
                                       ((1 lda) (1 *)) a-%offset%)
                 1)
                nm1)
               1))
     ...
     label110
      (setf t$
              (/ -1.0d0
                 (f2cl-lib:fref a-%data% (nm1 nm1) ((1 lda) (1 *))
                                a-%offset%)))
     ...
     label120
      (setf (f2cl-lib:fref a-%data% (n n) ((1 lda) (1 *)) a-%offset%)
              (+ (f2cl-lib:fref a-%data% (n n) ((1 lda) (1 *)) a-%offset%)
                 (* t$
                    (f2cl-lib:fref a-%data% (n nm1) ((1 lda) (1 *))
                                   a-%offset%))))
      (go label150)
     label140
      (setf info nm1)
