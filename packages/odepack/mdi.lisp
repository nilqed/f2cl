...
(defun mdi (n ia ja max v l head last$ next mark tag flag)
  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((sfs 0) (vi 0) (dvi 0) (vj 0) (nextvi 0) (k 0) (kmax 0) (lvk 0)
           (j 0) (jmax 0) (jmin 0))
      (declare
       (type (f2cl-lib:integer4) jmin jmax j lvk kmax k nextvi vj dvi vi sfs))
      ...
      (f2cl-lib:fdo (vi 1 (f2cl-lib:int-add vi 1))
        ...
        (tagbody
          ...
          (setf jmax
                  (f2cl-lib:int-sub
                   (f2cl-lib:fref ia-%data% ((f2cl-lib:int-add vi 1)) ((1 *))
                                  ia-%offset%)
                   1))
          (if (> jmin jmax)
              (go label6))
          (f2cl-lib:fdo (j jmin (f2cl-lib:int-add j 1))
            ...
            (tagbody
              ...
              (f2cl-lib:arithmetic-if (f2cl-lib:int-sub vj vi) (go label2)
                                      (go label5) (go label4))
             label2
              (setf lvk vi)
              (setf kmax
      ...
      (f2cl-lib:fdo (vi 1 (f2cl-lib:int-add vi 1))
        ...
        (tagbody
          ...
          (if (> nextvi 0)
              (setf (f2cl-lib:fref last$-%data% (nextvi) ((1 *))
                                   last$-%offset%)
                      vi))
         label7
