        ...
        (tagbody
          ...
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
            ...
            (tagbody
              (setf i
                      (f2cl-lib:int-add
                       (f2cl-lib:int-mul 2 (f2cl-lib:int-sub j 1)) 1))
              (setf t1
                      (f2cl-lib:fref a-%data% (j k) ((1 lda) (1 *))
                                     a-%offset%))
              (setf t2
                      (f2cl-lib:fref a-%data% ((f2cl-lib:int-add j 1) k)
                                     ((1 lda) (1 *)) a-%offset%))
              (setf c (f2cl-lib:fref q-%data% (i) ((1 *)) q-%offset%))
              (setf s
                      (f2cl-lib:fref q-%data% ((f2cl-lib:int-add i 1)) ((1 *))
                                     q-%offset%))
              (setf (f2cl-lib:fref a-%data% (j k) ((1 lda) (1 *)) a-%offset%)
                      (- (* c t1) (* s t2)))
              (setf (f2cl-lib:fref a-%data% ((f2cl-lib:int-add j 1) k)
                                   ((1 lda) (1 *)) a-%offset%)
                      (+ (* s t1) (* c t2)))
             label10))
         label20
         ...
         label50
          ...
          (setf (f2cl-lib:fref q-%data% ((f2cl-lib:int-add iq 1)) ((1 *))
                               q-%offset%)
                  s)
          (setf (f2cl-lib:fref a-%data% (k k) ((1 lda) (1 *)) a-%offset%)
                  (- (* c t1) (* s t2)))
          (if (= (f2cl-lib:fref a-%data% (k k) ((1 lda) (1 *)) a-%offset%)
                 0.0d0)
              (setf info k))
         label60))
      (go end_label)
     label70
      ...
      (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
        ...
        (tagbody
          ...
          (setf t2
                  (f2cl-lib:fref a-%data% ((f2cl-lib:int-add k 1) n)
                                 ((1 lda) (1 *)) a-%offset%))
          (setf c (f2cl-lib:fref q-%data% (i) ((1 *)) q-%offset%))
          (setf s
                  (f2cl-lib:fref q-%data% ((f2cl-lib:int-add i 1)) ((1 *))
          ...
          (setf (f2cl-lib:fref a-%data% (k n) ((1 lda) (1 *)) a-%offset%)
                  (- (* c t1) (* s t2)))
          (setf (f2cl-lib:fref a-%data% ((f2cl-lib:int-add k 1) n)
                               ((1 lda) (1 *)) a-%offset%)
                  (+ (* s t1) (* c t2)))
         label100))
      (setf info 0)
      ...
      (setf t2
              (f2cl-lib:fref a-%data% ((f2cl-lib:int-add n 1) n)
                             ((1 lda) (1 *)) a-%offset%))
      (if (/= t2 0.0d0)
          (go label110))
      (setf c 1.0d0)
