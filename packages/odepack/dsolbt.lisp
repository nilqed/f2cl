    ...
    (prog ((dp 0.0d0) (nm1 0) (nm2 0) (i 0) (k 0) (kb 0) (km1 0) (kp1 0))
        ...
        (tagbody
            ...
            (tagbody
              (setf dp
                      (ddot m
                       ...
                       m
                       (f2cl-lib:array-slice y-%data% double-float (1 km1)
                                             ((1 m) (1 n)) y-%offset%)
                       1))
          ...
          (dgesl
           ...
           (f2cl-lib:array-slice ip-%data% f2cl-lib:integer4 (1 k)
                                 ((1 m) (1 n)) ip-%offset%)
           (f2cl-lib:array-slice y-%data% double-float (1 k) ((1 m) (1 n))
                                 y-%offset%)
           0)
         label30))
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
                  ...
                  (+
                   (ddot m
                    (f2cl-lib:array-slice c-%data% double-float (i 1 n)
                                          ((1 m) (1 m) (1 n)) c-%offset%)
                    m
                    (f2cl-lib:array-slice y-%data% double-float (1 nm1)
                                          ((1 m) (1 n)) y-%offset%)
                    1)
                   (ddot m
                    ...
                    m
                    (f2cl-lib:array-slice y-%data% double-float (1 nm2)
                                          ((1 m) (1 n)) y-%offset%)
                    1)))
         ...
         label50))
      (dgesl
       (f2cl-lib:array-slice a-%data% double-float (1 1 n) ((1 m) (1 m) (1 n))
                             a-%offset%)
       m m
       (f2cl-lib:array-slice ip-%data% f2cl-lib:integer4 (1 n) ((1 m) (1 n))
                             ip-%offset%)
       (f2cl-lib:array-slice y-%data% double-float (1 n) ((1 m) (1 n))
                             y-%offset%)
       0)
        ...
        (tagbody
          ...
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
            ...
            (tagbody
              (setf dp
                      (ddot m
                       (f2cl-lib:array-slice b-%data% double-float (i 1 k)
                                             ((1 m) (1 m) (1 n)) b-%offset%)
                       m
                       (f2cl-lib:array-slice y-%data% double-float (1 kp1)
                                             ((1 m) (1 n)) y-%offset%)
                       1))
              (setf (f2cl-lib:fref y-%data% (i k) ((1 m) (1 n)) y-%offset%)
                      (-
      ...
      (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
        ...
        (tagbody
          (setf dp
                  (ddot m
                   (f2cl-lib:array-slice c-%data% double-float (i 1 1)
                                         ((1 m) (1 m) (1 n)) c-%offset%)
                   m
                   (f2cl-lib:array-slice y-%data% double-float (1 3)
                                         ((1 m) (1 n)) y-%offset%)
                   1))
