  ...
  (f2cl-lib:with-multi-array-data
    ...
    (prog ((dflag nil) (v 0) (l 0) (head 0) (tmp 0) (q 0) (next 0)
      ...
      (multiple-value-bind
          ...
          (md n ia ja max
           (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (v) ((1 *))
                                 isp-%offset%)
           (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (l) ((1 *))
                                 isp-%offset%)
           (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (head) ((1 *))
                                 isp-%offset%)
           p ip
           (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (v) ((1 *))
                                 isp-%offset%)
     ...
     label1
      ...
      (sro n ip ia ja a
       (f2cl-lib:array-slice isp-%data% f2cl-lib:integer4 (tmp) ((1 *))
                             isp-%offset%)
