      ...
      (f2cl-lib:with-multi-array-data
        ...
        (prog ((kmax 0) (kmin 0) (k 0) (j 0) (imul 0) (i 0))
          ...
          (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5)
              (funcall res neq t$ y
                       (f2cl-lib:array-slice wk-%data% double-float (ipa)
                                             ((1 *)) wk-%offset%)
                       ydot ier)
            (declare (ignore var-2 var-3 var-4))
            (when var-0 (setf neq var-0))
            (when var-1 (setf t$ var-1))
            (when var-5 (setf ier var-5)))
          (if (> ier 1)
              (go end_label))
          ...
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
            ...
            (tagbody
              (setf kmax
                      (f2cl-lib:int-sub
                       (f2cl-lib:fref iwk-%data% ((f2cl-lib:int-add ipian j))
                                      ((1 *)) iwk-%offset%)
                       1))
                ...
                (tagbody
                  (setf i
                          (f2cl-lib:fref iwk-%data%
                                         ...
                                         iwk-%offset%))
                 label20
                  (setf (f2cl-lib:fref wk-%data% ((f2cl-lib:int-add iba k))
                                       ((1 *)) wk-%offset%)
                          (f2cl-lib:fref tem-%data% (i) ((1 *))
                                         tem-%offset%))))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  (setf (gethash 'fortran-to-lisp::dainvgs
          ...
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            :return-values
                                            '(fortran-to-lisp::neq
                                              fortran-to-lisp::t$ nil nil nil
                                              nil nil fortran-to-lisp::ier nil
                                              nil)
