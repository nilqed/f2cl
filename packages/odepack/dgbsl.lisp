         ...
         label10
          (daxpy lm t$
           (f2cl-lib:array-slice abd-%data% double-float ((+ m 1) k)
                                 ((1 lda) (1 *)) abd-%offset%)
           1
           (f2cl-lib:array-slice b-%data% double-float ((+ k 1)) ((1 *))
                                 b-%offset%)
           1)
         label20))
     label30
      (f2cl-lib:fdo (kb 1 (f2cl-lib:int-add kb 1))
        ...
        (tagbody
          ...
          (daxpy lm t$
           (f2cl-lib:array-slice abd-%data% double-float (la k) ((1 lda) (1 *))
                                 abd-%offset%)
           1
     ...
     label50
      (f2cl-lib:fdo (k 1 (f2cl-lib:int-add k 1))
        ...
        (tagbody
          ...
          (setf t$
                  (ddot lm
                   (f2cl-lib:array-slice abd-%data% double-float (la k)
                                         ((1 lda) (1 *)) abd-%offset%)
                   1
                   (f2cl-lib:array-slice b-%data% double-float (lb) ((1 *))
                                         b-%offset%)
                   1))
          (setf (f2cl-lib:fref b-%data% (k) ((1 *)) b-%offset%)
