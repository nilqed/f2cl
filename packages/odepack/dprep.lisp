        ...
        (prog ((nzsut 0) (np1 0) (maxg 0) (liwk 0) (lenigp 0) (ldif 0) (kmin 0)
          ...
          (declare (type (double-float) dq dyj erwt fac yj)
                   (type (f2cl-lib:integer4) i ibr ier ipil ipiu iptt1 iptt2 j
                    jfound k knew kmax kmin ldif lenigp liwk maxg np1 nzsut))
         ...
         label30
          ...
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
            ...
            (tagbody
              ...
              (setf kmax
                      (f2cl-lib:int-sub
                       (f2cl-lib:fref ia-%data% ((f2cl-lib:int-add j 1))
                                      ((1 *)) ia-%offset%)
                       1))
              (if (> kmin kmax)
                  (go label45))
             ...
             label45
              ...
              (setf knew (f2cl-lib:int-add knew 1))
             label50
              (setf (f2cl-lib:fref iwk-%data% ((f2cl-lib:int-add ipian j))
                                   ((1 *)) iwk-%offset%)
          ...
          (f2cl-lib:fdo (j 1 (f2cl-lib:int-add j 1))
            ...
            (tagbody
              ...
              (multiple-value-bind (var-0 var-1 var-2 var-3 var-4 var-5 var-6)
                  (funcall jac neq tn y j
                           (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4
                                                 (ipian) ((1 *)) iwk-%offset%)
                           (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4
                                                 (ipjan) ((1 *)) iwk-%offset%)
                           savf)
              ...
              (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
                ...
                (tagbody
                  (setf dq
                          (/
                           (-
                            (f2cl-lib:fref ftem-%data% (i) ((1 *))
                                           ftem-%offset%)
                            (f2cl-lib:fref savf-%data% (i) ((1 *))
                                           savf-%offset%))
                           dyj))
                  (if (<= (abs dq) seth)
                      (go label110))
         ...
         label150
          (setf nnz
                  (f2cl-lib:int-sub
                   (f2cl-lib:fref iwk-%data% ((f2cl-lib:int-add ipian n))
                                  ((1 *)) iwk-%offset%)
                   1))
          (setf lenigp 0)
          ...
          (multiple-value-bind
              ...
              (jgroup n
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (ipian)
                                     ((1 *)) iwk-%offset%)
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (ipjan)
                                     ((1 *)) iwk-%offset%)
               maxg ngp
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (ipigp)
                                     ((1 *)) iwk-%offset%)
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (ipjgp)
                                     ((1 *)) iwk-%offset%)
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (iptt1)
                                     ((1 *)) iwk-%offset%)
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (iptt2)
                                     ((1 *)) iwk-%offset%)
               ier)
         ...
         label160
          ...
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
            ...
            (tagbody
             label170
              (setf (f2cl-lib:fref iwk-%data% ((f2cl-lib:int-add ibr i))
                                   ((1 *)) iwk-%offset%)
                      i)))
          ...
          (multiple-value-bind
              ...
              (odrv n
               ...
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (ipjan)
                                     ((1 *)) iwk-%offset%)
               wk
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (ipr) ((1 *))
                                     iwk-%offset%)
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (ipic)
                                     ((1 *)) iwk-%offset%)
               nsp
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (ipisp)
                                     ((1 *)) iwk-%offset%)
               1 iys)
            (declare
                  ...
                  (+
                   (max (the f2cl-lib:integer4 (truncate (* 12 n) lrat))
                        (+ (the f2cl-lib:integer4 (truncate (* 6 n) lrat))
                           (f2cl-lib:int-mul 2 n) nnz))
                   3))
          (setf lreq
                  (f2cl-lib:int-add
                   (f2cl-lib:int-sub (f2cl-lib:int-add lreq iprsp) 1) nnz))
          (if (> lreq lenwk)
              (go label250))
          ...
          (f2cl-lib:fdo (i 1 (f2cl-lib:int-add i 1))
            ...
            (tagbody
             label180
              (setf (f2cl-lib:fref wk-%data% ((f2cl-lib:int-add iba i)) ((1 *))
                                   wk-%offset%)
                      0.0d0)))
          (setf ipisp
                  (f2cl-lib:int-add
                   (f2cl-lib:int-mul lrat (f2cl-lib:int-sub iprsp 1)) 1))
          (multiple-value-bind
              (var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8 var-9
              ...
              (cdrv n
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (ipr) ((1 *))
                                     iwk-%offset%)
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (ipc) ((1 *))
                                     iwk-%offset%)
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (ipic)
                                     ((1 *)) iwk-%offset%)
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (ipian)
               ...
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (ipjan)
                                     ((1 *)) iwk-%offset%)
               (f2cl-lib:array-slice wk-%data% double-float (ipa) ((1 *))
                                     wk-%offset%)
               (f2cl-lib:array-slice wk-%data% double-float (ipa) ((1 *))
                                     wk-%offset%)
               (f2cl-lib:array-slice wk-%data% double-float (ipa) ((1 *))
               ...
               (f2cl-lib:array-slice iwk-%data% f2cl-lib:integer4 (ipisp)
                                     ((1 *)) iwk-%offset%)
               (f2cl-lib:array-slice wk-%data% double-float (iprsp) ((1 *))
                                     wk-%offset%)
               iesp 5 iys)
            (declare
             (ignore var-0 var-1 var-2 var-3 var-4 var-5 var-6 var-7 var-8
              var-9 var-10 var-11 var-13))
            (setf iesp var-12)
            (setf iys var-14))
          ...
          (setf nzu
                  (f2cl-lib:int-sub
                   (f2cl-lib:fref iwk-%data% ((f2cl-lib:int-add ipil n))
                                  ((1 *)) iwk-%offset%)
                   (f2cl-lib:fref iwk-%data% (ipil) ((1 *)) iwk-%offset%)))
          (setf nzl
                  (f2cl-lib:int-sub
                   (f2cl-lib:fref iwk-%data% ((f2cl-lib:int-add ipiu n))
                                  ((1 *)) iwk-%offset%)
         ...
         label190
          (if (and (= lrat 2) (= nnz n))
              (setf lreq (f2cl-lib:int-add lreq 1)))
  ...
  (setf (gethash 'fortran-to-lisp::dprep fortran-to-lisp::*f2cl-function-info*)
          (fortran-to-lisp::make-f2cl-finfo :arg-types
                                            ...
                                            '(nil nil nil nil nil nil nil nil
                                              nil nil fortran-to-lisp::ipper
                                              nil nil)
                                            :calls
                                            '(fortran-to-lisp::cntnzu
                                              fortran-to-lisp::adjlr
                                              fortran-to-lisp::cdrv
                                              fortran-to-lisp::odrv
